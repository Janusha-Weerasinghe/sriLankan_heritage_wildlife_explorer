...
//                }
//
//                // Fetch additional user data from Firestore (if you stored it during registration)
...
//                        self.alertMessage = "User data not found in Firestore."
//                        self.showingAlert = true
//                        return
//                    }
//
//                    // If user data exists, proceed to home
